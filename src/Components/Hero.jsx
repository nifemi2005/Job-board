...
const Hero = () => {
  return (
    <div className="bg-gray-200 px-9 flex flex-col md:flex-row justify-between items-center">
      ...
      <div>
        <img src={Hero_img} alt="Team working together" className="mb-7 md:mb-12 mt-10 md:w-[400px] lg:w-[500px]" />
      </div>
    </div>
  );
};
