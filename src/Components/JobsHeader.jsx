...
const JobsHeader = ({count, sortOption, setSortOption}) => {
  return (
    <div className='px-4 md:px-9 py-5 sm:py-5 flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-6 border-b border-gray-200 pb-6'>
        ...
        <div className='flex items-center gap-3'>
            ...
            <select value={sortOption} onChange={(e) => setSortOption(e.target.value) } className='border rounded-lg border-gray-900 text-sm px-3 py-2 bg-gray-100 text-gray-800'>
